...
int main(void)
{
    ...
    while ((de = readdir(dir1)) != NULL)
        printf("%s\n", de->d_name);
    if (execl("/Users/gongcunjust/c_program/sys_program/process_control/exercises/exec2", 
           "exec2", "/Users/gongcunjust/c_program/sys_program/process_control/exercises/DIR", (char *)0) < 0) 
        err_sys("execl error");
