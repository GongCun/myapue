...
timeout(const struct timespec *when, void (*func)(void *), void *arg)
{
    ...
    if ((when -> tv_sec > now.tv_sec) ||
        ...
        /* printf("when -> tv_sec is %lu\n", (unsigned long)when -> tv_sec); */
        ...
        if (tip != NULL) {
            ...
            /*
            printf("tip -> to_wait.tv_sec is %lu\n", (unsigned long)tip -> to_wait.tv_sec);
            printf("tip -> to_wait.tv_nsec is %lu\n\n", (unsigned long)tip -> to_wait.tv_nsec);
            */
